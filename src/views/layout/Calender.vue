      ...
      <div class="inner">
        <div class="location">
          <div>
            ...
            {{weather.province}} - {{weather.city}}</div>
          <div class="weather">
            今日天气&nbsp;:&nbsp;<span :style="{color: '#00bb00'}">{{weather.weather}}</span> &nbsp;今日温度&nbsp;:&nbsp;<span :style="{color: '#00bb00'}">{{weather.temperature}}℃</span>
            &nbsp;今日湿度&nbsp;:&nbsp;<span :style="{color: '#00bb00'}">{{weather.humidity}}%</span> &nbsp;今日风向&nbsp;:&nbsp;<span :style="{color: '#00bb00'}">{{weather.winddirection}}风</span>
          </div>
        </div>
