<template>
  <div>
    <div class="my_card user-card">
      ...
      <el-table :data="dataSource" style="width: 100%" v-loading="loading" element-loading-text="拼命加载中" ref="tableRef"
        border>
        ...
        <el-table-column label="操作">
          <template v-slot="scope">
            ...
            <el-button type="text" style="color: #f56c6c" v-if="isSuperAdmin" @click="deleteUser(scope.row.id)">删除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="用户权限" v-model="showDrawer" destroy-on-close>
