    ...
    <el-form :model="articleData" :rules="rules" ref="articleFormRef" label-width="80px" class="article_form"
        ...
        <el-form-item label="文章封面" prop="article_cover">
            ...
            <el-drawer title="图库" v-model="cloudGallery.dialogGalleryVisible" direction="rtl" size="35%">
                ...
                <el-pagination layout="prev, pager, next" :hide-on-single-page="true" background
                    :total="cloudGallery.total" :page-size="12" @current-change="pageChange" style="margin-top: 20px">
                </el-pagination>
            </el-drawer>
        </el-form-item>
        ...
        <el-form-item label="发布时间" prop="post_date">
            <el-date-picker v-model="articleData.post_date" type="datetime" format="YYYY-MM-DD HH:mm:ss"
                placeholder="选择更新时间" :shortcuts="shortcuts">
            </el-date-picker>
        </el-form-item>
    </el-form>
</template>
